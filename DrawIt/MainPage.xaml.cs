...
namespace DrawIt
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void btnClearScreen_Click(object sender, RoutedEventArgs e)
        {
            ...
            UICommand c1 = new UICommand("Yes");
            c1.Invoked = c1inv;
            UICommand c2 = new UICommand("No");

            var MsgDlg = new MessageDialog(" ", " Do You Want to Clear Screen? ");
            MsgDlg.Commands.Add(c1);
            MsgDlg.Commands.Add(c2);
     
            MsgDlg.ShowAsync();

        }

        private void c1inv(IUICommand command)
        {
